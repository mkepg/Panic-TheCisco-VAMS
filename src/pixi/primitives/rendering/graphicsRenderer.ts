...
import { pxToWorld, bboxRadii, buildEllipsePoints, createPaddedHitArea } from "../utils/geometryUtils";
...
export function drawWithGraphics(
  ...
  // Polygon and Hexagon/Star fallback leverages PIXI's internal robust concave earcut handler 
